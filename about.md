...
<div class="small-12 medium-7 columns">
  <section class="bio">
    ...
    <p>I am a <span class="rainbow">devzgner</span> <code>/devzīnər/</code>, designer + developer, currently based in Pittsburgh, PA, USA working on healthcare technologypreviously working with organizations like GE Healthcare & the NBA on consumer and enterprise applications.</p>
