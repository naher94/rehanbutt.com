...
<div class="scaffold-grid content-grid">
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/logo.svg" alt="Logo"/>
  </div>
</div>
...
<div class="scaffold-grid content-grid gy py">
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/home.jpg" alt="Home page and upload page">
  </div>
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/404.jpg" alt="Fun 404 page">
  </div>
    <div class="scaffold-grid-span-full">
      <img src="../img/interchange/mobile.jpg" alt="Mobile Site Screenshots"/>
  </div>
</div>
...
<div class="scaffold-flex content-flex gx px gy py">
  <div class="w-12 md:w-6">
    <img src="../img/interchange/dylan.jpg" alt="Wayfinding Stickers with Dylan in motion">
  </div>
  <div class="w-12 md:w-6">
    <img src="../img/interchange/crossover.jpg" alt="Wayfinding Stickers">
  </div>
  <div class="w-12" style="display: flex; flex: calc(1050/1400);">
    <img src="../img/interchange/stairs.jpg" alt="Wayfinding stickers on the stairs">
  </div>
  <div class="w-12" style="display: flex; flex: calc(1400/1050);">
    <img src="../img/interchange/codelab-entry.jpg" alt="Wayfinding stickers at CodeLab entry">
  </div>
  <div class="w-12">
    <img src="../img/interchange/codelab.jpg" alt="Inside the CodeLab">
  </div>
</div>
...
<div class="scaffold-grid content-grid gy py">
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/sketches.jpg" alt="Sketches"/>
  </div>
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/floor-plan.jpg" alt="Floor plan for wayfinding">
  </div>
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/brandInspiration.png" alt="Brand Inspiration"/>
  </div>
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/logo-iterations.svg" alt="Logo Iterations"/>
  </div>
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/postcardIterations.png" alt="Postcard Iterations"/>
  </div>
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/posterSeries.png" alt="Poster Series"/>
  </div>
  <div class="scaffold-grid-span-full">
    <img src="../img/interchange/stickerTest.png" alt="Floor Sticker Test"/>
  </div>
</div>
