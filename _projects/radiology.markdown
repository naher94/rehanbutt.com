...
<div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/radiology-house-md.jpg" alt="Lightbox room from House MD" /></div>
<div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/radiology-greys-anatomy.jpg" alt="X-Ray Image review from Grey's Anatomy" /></div>
</div>
...
<div class="scaffold-grid content-grid gx px gy">
  <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/workstations1.svg" alt="Variety of Radiology Workstations" /></div>
  <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/workstations2.svg" alt="Variety of Radiology Workstations" /></div>
</div>
...
<div class="scaffold-grid content-grid gx px gy">
  <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/bluesky-aggregator.jpg" alt="Bluesky exploration of what a Patient Hub might look like" /></div>
  <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/bluesky-viewer.jpg" alt="Bluesky exploration of a simple image viewer for use with the paired patient hub" /></div>
</div>
...
<div class="scaffold-grid content-grid gy">
  <div class="scaffold-grid-span-full"><img src="../img/radiology/customization-configurator.jpg" alt="Various customization tools from the gaming and graphics industry" /></div>
</div>
...
<div class="scaffold-flex content-flex gy center">
  <div class="w-12 md:w-10"><img src="../img/radiology/voice-commands-label.svg" alt="Voice Command Diagram Labeling Vertabrae" /></div>
  <div class="w-12 md:w-10"><img src="../img/radiology/voice-commands-window.svg" alt="Voice Command Diagram Applying Lung Window" /></div>
</div>
<!-- reporting stuff? -->
...
<div class="scaffold-grid content-grid gx px gy">
  <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/color-audit1.svg" alt="Color Swatches" /></div>
  <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/color-audit2.svg" alt="Color Swatches" /></div>
  <div class="scaffold-grid-span-half md:scaffold-grid-span-quarter"><img src="../img/radiology/audit-icons.png" alt="Inconsistent Icon Use" /></div>
  <div class="scaffold-grid-span-half md:scaffold-grid-span-quarter"><img src="../img/radiology/audit-menus1.png" alt="Text Only Menu" /></div>
  <div class="scaffold-grid-span-half md:scaffold-grid-span-quarter"><img src="../img/radiology/audit-menus2.png" alt="Icon Only Menu with Hover Text" /></div>
  <div class="scaffold-grid-span-half md:scaffold-grid-span-quarter"><img src="../img/radiology/audit-menus3.png" alt="Icon and Text Menu" /></div>
</div>
...
<div class="scaffold-grid content-grid gx px gy">
  <div class="scaffold-grid-span-full"><img src="../img/radiology/panel-concept-diagram.jpg" alt="Scalable Panel based Concept Diagram" /></div>
  <div class="scaffold-grid-span-full"><img src="../img/radiology/panel-concept-mockup.jpg" alt="Scalable Panel based Concept Sample Mockup" /></div>
</div>
...
<div class="scaffold-grid content-grid gx px gy">
  <div class="scaffold-grid-span-full"><img src="../img/radiology/communication-network.svg" alt="Communication Network Diagram for Radiology" /></div>
  <div class="scaffold-grid-span-full"><img src="../img/radiology/communication-consult-workflow.svg" alt="Communication Consultation Workflow Diagram" /></div>
</div>
...
<div class="scaffold-grid content-grid">
  <div class="scaffold-grid-span-full"><img src="../img/radiology/medical-journals-radiology.png" alt="Several Medical Journal Articles about Infomatics and AI in Medicine" /></div>
</div>
...
<div class="scaffold-flex content-flex gx px gy center">
  <div class="w-12 md:w-7" style="margin-top: 4em;"><img src="../img/radiology/z-layers-concept.svg" alt="Z-Index Ordering Concept Layers" /></div>
</div>
...
<div class="scaffold-grid content-grid gx px gy">
    <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/z-layers-diagram.svg" alt="Z-Index Viewport Diagram" /></div>
    <div class="scaffold-grid-span-full md:scaffold-grid-span-half"><img src="../img/radiology/z-layers-viewport.svg" alt="Z-Index Ordering Applied to Diagnostic Viewport" /></div>
</div>
